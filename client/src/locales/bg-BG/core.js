...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'За Marks Plan',
      ...
      discoverPlankaPro: '✨ Повече функции за вашите дъски: Открийте Marks Plan Pro',
      discoverPlankaPro_title: 'Открийте Marks Plan Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'Marks Plan използва <1><0>Apprise</0></1> за изпращане на уведомления до над 100 популярни услуги.',
      port: 'Порт',
