...
export default {
  ...
  translation: {
    common: {
      ...
      discoverPlankaPro: '✨ Více funkcí pro vaše tabule: Objevte Marks Plan Pro',
      discoverPlankaPro_title: 'Objevte Marks Plan Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'Marks Plan používá <1><0>Apprise</0></1> k zasílání oznámení do více než 100 oblíbených služeb.',
      port: 'Port',
      preferences: 'Volby',
