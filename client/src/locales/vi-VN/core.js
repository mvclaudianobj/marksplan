...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Về Marks Plan',
      ...
      discoverPlankaPro: '✨ Nhiều tính năng hơn cho bảng của bạn: Khám phá Marks Plan Pro',
      discoverPlankaPro_title: 'Khám phá Marks Plan Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'Marks Plan sử dụng <1><0>Apprise</0></1> để gửi thông báo tới hơn 100 dịch vụ phổ biến.',
      port: 'Cổng',
