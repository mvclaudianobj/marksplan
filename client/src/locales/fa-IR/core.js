...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'درباره Marks Plan',
      ...
      discoverPlankaPro: '✨ ویژگی‌های بیشتر برای تابلوهای شما: Marks Plan Pro را کشف کنید',
      discoverPlankaPro_title: 'Marks Plan Pro را کشف کنید',
